        ...
        <div>
          <div className="flex justify-between items-start">
            <p className="text-neutral-200 text-xs md:text-sm font-normal mb-8">
              Built E-commerce application from scratch <br />
              click to preview
            </p>
            <Shimmer href="https://cartzeno.vercel.app/" />
          </div>
      ...
      content: (
        <div>
          <div className="flex justify-between items-start">
            ...
            <Shimmer href="https://zainashraf005.github.io/apnabaazar/" />
          </div>
